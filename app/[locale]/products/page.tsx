...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  return {
    ...
    title: locale === 'es' ? 'Cargadores EV y Camiones Eléctricos Clase 8' : 'EV Chargers & Class 8 Electric Trucks',
    description,
  ...
  itemListElement: [
    {
      ...
      item: {
        ...
        description: 'Autel MaxiCharger DC HiPower. Cabinet architecture from 320 kW to 640 kW, delivering up to 480 kW to a single vehicle. Ideal for highway hubs, fleet depots, and high-traffic commercial locations.',
        offers: { '@type': 'Offer', seller: { '@type': 'Organization', name: 'Greenspace E-mobility' }, areaServed: ['Panama', 'Mexico', 'United States'] },
        additionalProperty: [
          { '@type': 'PropertyValue', name: 'Power Output', value: '320–640 kW (up to 480 kW per vehicle)' },
